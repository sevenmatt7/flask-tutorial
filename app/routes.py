...
# this code will be executed right before the view function gets executed
@app.before_request
def before_request():
...
@app.route('/', methods=['GET', 'POST'])      #decorators which modifies the function that follows it
@app.route('/index', methods=['GET', 'POST']) #when there is a request for the URLs, Flask is going to invoke
